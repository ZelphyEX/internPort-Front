...
export const INITIAL_TASKS: TaskItem[] = [
  {
    ...
    assignedInternIds: ['INT-001'],
    assignedInternNames: ['Nguyễn Văn An'],
  ...
  },
  {
    ...
    assignedInternIds: ['INT-002'],
    assignedInternNames: ['Lê Thị Bích'],
  ...
  },
  {
    ...
    assignedInternIds: ['INT-003'],
    assignedInternNames: ['Trần Minh Đức'],
  ...
  },
  {
    ...
    assignedInternIds: ['INT-004'],
    assignedInternNames: ['Phạm Hoàng Long'],
  ...
  },
  {
    ...
    assignedInternIds: ['INT-005'],
    assignedInternNames: ['Vũ Thảo Nguyên'],
