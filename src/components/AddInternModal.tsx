    ...
    <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl max-w-lg w-full p-6 shadow-2xl border border-slate-200 space-y-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-3 text-xs">
          <div>
            <label className="font-bold text-slate-700 block mb-1">Họ và tên thực tập sinh *</label>
            <input
              type="text"
              required
              value={name}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="font-bold text-slate-700 block mb-1">Email Gimasys *</label>
              <input
                type="email"
                required
                value={email}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="font-bold text-slate-700 block mb-1">Khối Kỹ thuật *</label>
              <select
                value={department}
            ...
            <div>
              <label className="font-bold text-slate-700 block mb-1">Mentor hướng dẫn</label>
              <input
                type="text"
                value={mentor}
